...
namespace POSPeachie
{
    public partial class frmPOS : Form
    {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (colName == "Delete")
            {
                if (MessageBox.Show("REMOVE THIS ITEM? CLICK YES TO CONFIRM.", stitle, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    cn.Open();
            ...
            else if (colName == "colAdd")
            {
                ...
                {
                    MessageBox.Show("REMAINING QY ON HAND IS " + i + " !", "WARNING", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
            }
        }
        ...
        private void btnCancel_Click(object sender, EventArgs e)
        {
            if(MessageBox.Show("REMOVE ALL ITEMS FROM THE CART?", "CONFIRM", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                cm.ExecuteNonQuery();
                cn.Close();
                MessageBox.Show("ALL ITEMS HAS BEEN SUCCESSFULLY REMOVED!.", "REMOVED ITEM", MessageBoxButtons.OK, MessageBoxIcon.Information);
                LoadCart();
            }
        }
    }
